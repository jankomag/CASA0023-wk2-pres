...
I believe the Landsat 9 satellite and the two sensors attached to it will be immensely useful for advancing global research. This satellite gave rise to a new generation of sensors of data for public good, since the captured data are made publicly available by USGS. I remain excited to learn about the this and all future satellites, and I hope the technological progress will enable new types of sensors with higher accuracy to become available to the public.


```{r, echo = FALSE, out.width='70%', fig.align='center'}
  knitr::include_graphics('res/L9SanFrancisco.jpg')
```
Image of San Francisco from Landsat's 9 OLI-2 sensor
